...
<link rel="stylesheet" href="/resources/css/jquery.treeview.css" />
	...
	$(document).ready(function(){
		...
		//매출보고서
		$('#slsReport').on('click',function(){
			window.open("/edoc/slsReport?edoFormClsf=EDOCFORM08", "_blank", "toolbar=yes, scrollbars=yes, resizable=yes, top=500, left=500, width=800, height=1100");
		}) ;
			...
			<ul>
						...
						<li class=""><span class="folder" data-deptNo="dept001" style="font-size : 2.1em; font-weight : bold;">총무/회계</span>
							<ul id="folder21">
								...
								<li><span class="file" data-empno="230000" id="slsReport" style="font-size : 1.8em;">매출보고서</span></li>
							</ul>
						</li>
			</ul>
		</li>
